...
- **Core bugfix or docs for Vini AI itself:** contribute back to `agent0ai/agent-zero` from a public fork.
- **Community plugin:** publish the plugin in its own public repository, then submit it to `agent0ai/a0-plugins`.
- **Reusable skill:** contribute it to Vini AI's `skills/` tree or publish it in a dedicated public repository/collection.
