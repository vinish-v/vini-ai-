...
If Vini AI runs in Docker, remember that "localhost" means the container, not
always your host machine.

| Where the MCP tool runs | Address to use from Vini AI |
| --- | --- |
...
| Inside Vini AI's container | A command-based config |
