...
### 1. Is this change meant for the Vini AI core repository?
...
- it is portable across Vini AI, Cursor, Claude Code, or Copilot-style ecosystems
...
3. Move it into `skills/` for an Vini AI contribution, or publish it in a dedicated public repository/collection.
