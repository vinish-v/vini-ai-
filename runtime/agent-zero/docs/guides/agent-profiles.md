...
Use a profile when you want Vini AI to behave like a researcher, developer,
...
When you click it, Vini AI places a ready-to-send message in the chat input.
Send that message and Vini AI starts a guided profile-creation flow.
