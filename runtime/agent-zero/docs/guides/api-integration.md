...
One of Vini AI's most powerful capabilities is the ability to integrate external APIs on the fly without writing any code. By simply providing API documentation or code snippets, the agent can learn to use new services and remember how to use them in future conversations.
...
### Step 2: Provide the Code to Vini AI

Now we'll tell Vini AI to use this code:

1. Open a chat with Vini AI
2. Send a message like: **"Use this code to generate an image of the Vini AI logo"**
3. Either:
   - Attach the downloaded Python file, or
   - Paste the code snippet into the chat

Vini AI will analyze the code and understand:
- What dependencies are needed (`google-genai` package)
- How to structure the API request
- What parameters are required
- How to handle the response

![Vini AI analyzing the API code](../res/usage/api-int/api-int-2image-gen-api2.png)

### Step 3: Configure API Credentials

On first run, Vini AI will attempt to use the API but discover it needs an API key:

![Missing API key error](../res/usage/api-int/api-int-3-api-key-missing-secrets.png)

Vini AI will tell you:
...
After configuring the API key, tell Vini AI to proceed:
...
Vini AI can save useful API patterns in memory so you do not have to explain
...
> [!IMPORTANT]
> Memory still needs curation. If Vini AI keeps using an old API pattern,
...
For APIs you use frequently, you can have Vini AI create reusable wrapper functions:
...
By showing Vini AI a working API example, you can:
