...
Contributions to improve Vini AI are very welcome!  This guide outlines how to contribute code, documentation, or other improvements.
...
1. **Fork the Repository:** Fork the Vini AI repository on GitHub.
...
- **Code Style:** Follow the existing code style. Vini AI generally follows PEP 8 conventions.
...
2. **Create a Pull Request:** Create a pull request from your branch to the appropriate branch in the main Vini AI repository.
...
- **Core bugfixes and docs for Vini AI itself:** prepare them in a clean fork/clone of `agent-zero` and open a PR back to the upstream repository.
...
- **Skills:** develop locally in `usr/skills/`, then move stable skills to `skills/` for Vini AI contributions or publish them in a dedicated public repository/collection.
