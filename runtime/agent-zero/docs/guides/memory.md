...
Vini AI can remember useful facts, solutions, preferences, and imported
...
When Vini AI does something unexpected, keeps repeating a bad habit, or seems
...
Start with ordinary words. If Vini AI keeps using the wrong command, search
...
Check Memory early when Vini AI:
...
If Vini AI is mixing contexts, check whether the memory belongs in global
...
- [Usage Guide](usage.md): where Memory fits in the everyday Vini AI workflow.
- [Projects Guide](projects.md): how project memory keeps client, repo, and task context separated.
- [Troubleshooting](troubleshooting.md): quick checks when Vini AI behaves unexpectedly.
