...
Skills are focused instructions Vini AI can load when a task needs them.

Most of the time, you do not need to think about skills. Ask for the work you
want, and Vini AI can load a matching skill on demand.
...
Vini AI sees them every turn while they are active.

> [!TIP]
> Keep this list short. Pin the skills you really want present all the time, and
> let Vini AI load the rest only when it needs them.
...
If Vini AI starts following an old procedure you no longer want, open the
