...
This guide is the practical tour of Vini AI after installation. It explains
...
details, use [DeepWiki for Vini AI](https://deepwiki.com/agent0ai/agent-zero).

![Vini AI first task](../res/usage/first-task.png)

## Basic Operations

Vini AI is built around a chat, a working Linux environment, and a Web UI that
...
- **Memory:** review what Vini AI has learned or imported.
- **Tasks:** create scheduled, planned, or manual automations.
- **Files:** open the Vini AI file browser.
...
Skills are focused instructions Vini AI can load when it needs them. You can
...
message in the input so Vini AI can guide you through creating a new profile.
...
can remove mistakes before Vini AI starts working.

## Tool Usage

You usually do not need to name tools. Say what you want done and Vini AI will
...
The Desktop surface opens Vini AI's own Linux desktop in the Canvas.
...
while Vini AI creates, updates, saves, and verifies the same files.
...
Vini AI instances can communicate through A2A when you want multiple
instances to collaborate.

Use A2A when you have a clear reason to split work across Vini AI instances,
such as a specialist server, a remote machine, or a project-specific agent. See
[A2A Setup](a2a-setup.md).

### Multi-Agent Cooperation

Inside a single Vini AI instance, the main agent can create subordinate agents
...
Projects tell Vini AI what world it is working in. Use one when a chat needs
...
Good project instructions tell Vini AI what should be different in that
workspace:
...
Tasks let Vini AI run work later, repeatedly, or on demand.
...
- **Prompt:** the actual work Vini AI should perform.
...
Tunnels let you reach your local Vini AI instance from another device or
...
Vini AI supports text-to-speech and speech-to-text through built-in voice plugins:
...
Use the **Voice** section in Agent settings or the plugin settings in **Agent Plugins** to configure providers. Use the sidebar **Speech** preference when you want Vini AI to read responses automatically.
...
Vini AI can render mathematical notation with KaTeX.
...
The File Browser lets you inspect and manage files inside the Vini AI
environment.
...
Memory is where Vini AI keeps useful remembered information from conversations
...
If Vini AI does something unexpected, repeats a wrong behavior, or seems to
