...
class BackupService:
    """
    Core backup and restore service for Vini AI.
    ...
    def __init__(self):
        ...
        self.agent_zero_root = files.get_abs_path("")  # Resolved Vini AI root
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes Vini AI project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up Vini AI root path with the current Vini AI root path
