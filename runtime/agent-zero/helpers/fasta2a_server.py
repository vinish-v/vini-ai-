...
class AgentZeroWorker(Worker):  # type: ignore[misc]
    """Vini AI implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through Vini AI."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to Vini AI format
            ...
            # Process message through Vini AI (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to Vini AI UserMessage."""
    ...
    def _configure(self):
        ...
        try:
            ...
            provider: AgentProvider = {  # type: ignore
                "organization": "Vini AI",
                "url": "https://github.com/frdel/vini-ai"
            }
