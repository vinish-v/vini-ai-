# Vini AI Capabilities

Vini AI can:
- run terminal and code execution tools inside the Docker/server runtime
- use Vini AI CLI connector tools for host/local machine execution when connected and enabled
...
Important boundary:
- Docker/server tools operate inside the Vini AI container, usually `/a0/usr/workdir`.
- Vini AI CLI remote tools operate on the connected host machine, usually the CLI working directory.
