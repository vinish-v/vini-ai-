...
description: Create, inspect, install, and safely maintain Chrome extensions for Vini AI's built-in Browser plugin. Use when the user asks to build a browser extension, modify an existing extension, install a Chrome Web Store extension, or review extension permissions.
---

# Vini AI Browser Extensions

Use this skill when the user wants to create a new Browser extension, modify an existing extension, or install a Chrome Web Store extension for Vini AI's direct `_browser` plugin.

## Operating Model

- Vini AI loads Browser extensions from unpacked directories.
...
{
  "manifest_version": 3,
  "name": "Vini AI Example Extension",
  "version": "0.1.0",
  "description": "Small, auditable Browser extension created with Vini AI.",
  "permissions": [],
  "host_permissions": [],
  "action": {
