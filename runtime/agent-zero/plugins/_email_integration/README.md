...
Communicate with Vini AI through email inboxes and send replies back over SMTP.
...
- **Thread routing**
  ...
  - Email replies inside an existing Vini AI thread can use `/project`, `/config`, and `/send` control commands.
...
- **Description**: Communicate with Vini AI via email. Supports IMAP/Exchange inbox polling with SMTP replies.
