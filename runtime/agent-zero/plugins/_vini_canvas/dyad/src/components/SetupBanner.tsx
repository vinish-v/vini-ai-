  ...
  if (itemsNeedAction.length === 0) {
    return (
      <div className="mb-8 text-center">
        <div
          className="text-5xl font-bold tracking-normal text-white"
          style={{ fontFamily: '"Times New Roman", Georgia, serif' }}
        >
          VINI AI
        </div>
        <h1 className="mt-4 text-center text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-gray-100 dark:to-gray-400 tracking-tight">
          {t("setup.buildNewApp")}
        </h1>
      </div>
    );
