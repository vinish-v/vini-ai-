...
def test_host_computer_use_does_not_fall_back_to_linux_desktop_skill():
    ...
    assert "Those paths only see the internal Vini AI runtime" in host_skill
    ...
    assert "`desktopctl.sh` only targets the internal Vini AI Xpra display" in linux_skill
