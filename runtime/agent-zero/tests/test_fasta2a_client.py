...
def print_troubleshooting():
    ...
    print("   - Make sure Vini AI is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ Vini AI server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to Vini AI server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start Vini AI server if not running")
